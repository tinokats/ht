...
if (isset($_POST['submit'])) {
    $email = $_POST['email'];
    $pass = $_POST['password'];
    $que = mysqli_query($con, "select * from users where email='$email' and password='$pass'");
    $row = mysqli_num_rows($que);
    if ($row) {
        $_SESSION['users'] = $email;
        echo "<script>window.location = 'user/user-dashboard.php'</script>";
    } else {
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="email" id="uname" type="text" placeholder="enter your email">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
